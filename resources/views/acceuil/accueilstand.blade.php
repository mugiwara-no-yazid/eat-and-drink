...
<body>
 ...
 <nav class="nav">
  ...
  <section class="banner">
    ...
    <p>Découvrez 8 artisans passionnés et leurs spécialités</p>
  </section>

  <!-- SEARCH BAR -->
  <section class="search-filter">
    <input type="text" placeholder="Rechercher un stand...">
    <select>
  ...
  <!-- SECTION PRODUITS -->
  <div class="container">
    <h2 style="margin-bottom: 20px; color: #444;">8 stands trouvés</h2>
    
    <div class="grid">

      <!-- Exemple de carte produit statique -->
    <div class="card">
        <img src="/images/stand1.jpg" alt="Nom du Stand">
        <div class="card-body">
          <div class="card-header">
            <h3>Nom du Stand</h3>
            <span class="badge">Boulangerie</span>
          </div>
          <div class="details">
            📍 Stand A12 • ★ 4.9
          </div>
          <p class="description">
            Produits artisanaux faits maison, spécialités locales à découvrir.
          </p>
          <a href="{{ route('stands.voir', $stand->id) }}">Voir stand</a>
        </div>
      </div>  
